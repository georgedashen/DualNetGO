...
def parser_args():
    ...
    parser.add_argument('--dataset_dir', help='dir of dataset', default='../data/human')
...
def main_worker(args, logger):
    ...
    if args.feature:
        np.save(f'{args.dataset_dir}/{args.org}_net_feature_MLPAE.npy', output)
    else:
        np.save(f'{args.dataset_dir}/{args.org}_net_{args.evidence}_MLPAE.npy', output)
