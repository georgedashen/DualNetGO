...
class EncoderTransformer(nn.Module):
    ...
    def __init__(self, dim_feedforward=2048, nhead=8, num_encoder_layers=6,
        ...
        if num_encoder_layers > 0:
            encoder_layer = TransformerEncoderLayer(dim_feedforward, nhead, 
...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, dim_feedforward, nhead, dropout=0.1,
                 activation="relu", normalize_before=False, last_encoder=False):
        super().__init__()
