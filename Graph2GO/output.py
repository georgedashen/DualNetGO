...
parser.add_argument('--out', type=str, default='results_AUPR.csv')
...
checkpt_file = f'{args.org}_{args.aspect}_seed{args.seed}_model.pkl'
...
with open(args.out, 'a') as f:
    csv.writer(f).writerow([args.org, args.aspect, test_perf['Fmax'], test_perf['F1'], test_perf['M-F1'], test_perf['acc'], test_perf['m-aupr'], test_perf['M-aupr'], test_perf['M-aupr-labels']])
