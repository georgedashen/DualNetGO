...
# Training settings
example_usage = 'CUDA_VISIBLE_DEVICES=7 nohup python DualNetGO_mouse.py --step1_iter 200 --step2_iter 30 --max_feat_select 5 --num_adj 7 --epochs 100 --aspect C --dropout1 0.5 --dropout2 0.5 --dropout3 0.1 --lr_fc1 0.01 --lr_fc2 0.01  --hidden 512 --lr_sel 0.01 --embedding AE'
...
parser.add_argument('--embedding', type=str, default='GAE', help='what kind of embedding to use')
...
if args.comet:
    with open('/home/zhuoyang/comet_API_token','r') as f:
        experiment = Experiment(f.read().rstrip(), project_name="DualNetGO_mouse_best")
...
# load features
with open('data/features_mouse.npy', 'rb') as f:
    Z = pickle.load(f)
list_mat.append(Z)
del Z
...
if args.embedding != 'None':
    ...
    num_nodes = 21317
n_class_dict = {'P':42, 'F':17, 'C':37}
num_labels = n_class_dict[args.aspect]
num_feat = 1247 # feature dim
